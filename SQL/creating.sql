...
CREATE TABLE ESTRELA(
    ...
    GALAXIA VARCHAR2(50),
   	ESTRELA VARCHAR2(50),
    CONSTRAINT PK_ESTRELA PRIMARY KEY (NOME, GALAXIA, ESTRELA),
    CONSTRAINT FK_ESTRELA FOREIGN KEY (NOME, GALAXIA) REFERENCES SISTEMA_PLANETARIO(NOME, GALAXIA) ON DELETE CASCADE
);
...
CREATE TABLE MISSAO_ESPACIAL (
    ...
    NOME_BASE VARCHAR2(25) NOT NULL,
...
CREATE TABLE ROTA_MISSAO(
	...
	CONSTRAINT FK_ROTA_MISSAO1 FOREIGN KEY (MISSAO) REFERENCES MISSAO(ID) ON DELETE CASCADE,
...
CREATE TABLE RECURSO_PLANETA(
	PLANETA NUMBER(15),
	NOME_REC VARCHAR2(25),
	tipo_REC VARCHAR2(25),
...
CREATE TABLE MISSAO_EXPLORACAO (
	...
	NOME_BASE_DEST VARCHAR2(25) NOT NULL,
	CONSTRAINT PK_MISSAO_EXPLORACAO PRIMARY KEY (MISSAO),
	CONSTRAINT FK_MISSAO_EXPLORACAO1 FOREIGN KEY (MISSAO) REFERENCES MISSAO(ID) ON DELETE CASCADE,
...
CREATE TABLE MISSAO_COMERCIO (
	...
	CONSTRAINT FK_MISSAO_COMERCIO1 FOREIGN KEY (MISSAO) REFERENCES MISSAO(ID) ON DELETE CASCADE,
...
CREATE TABLE MISSAO_COLONIZACAO (
	...
	CONSTRAINT FK_MISSAO_COLONIZACAO1 FOREIGN KEY (MISSAO) REFERENCES MISSAO(ID) ON DELETE CASCADE,
...
CREATE TABLE COMERCIO_PRODUTO (
	...
	NOME_CIV VARCHAR2(25),
	CATEG_CIV CHAR(1),
	TIPO_COMERCIO VARCHAR2(25) NOT NULL,
