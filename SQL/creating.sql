...
CREATE TABLE CIVILIZACAO_HABITA_PLANETA(
    ...
    CONSTRAINT FK_CIVILIZACAO_HABITA_PLANETA1 FOREIGN KEY (NOME_CIVILIZACAO, CATEGORIA_CIVILIZACAO) REFERENCES CIVILIZACAO(NOME, CATEGORIA) ON DELETE CASCADE,
    CONSTRAINT FK_CIVILIZACAO_HABITA_PLANETA2 FOREIGN KEY (PLANETA) REFERENCES PLANETA(ID) ON DELETE CASCADE
);
...
CREATE TABLE AMEACA (
	...
	NIVEL NUMBER(5) NOT NULL,
 	CONSTRAINT PK_AMEACA PRIMARY KEY (NOME) ON DELETE CASCADE
);
...
CREATE TABLE AMEACA_CIVILIZACAO (
	...
	CATEG_CIV CHAR(1),
 	CONSTRAINT PK_AMEACA_CIVILIZACAO PRIMARY KEY (AMEACA, NOME_CIV, CATEG_CIV),
    CONSTRAINT FK_AMEACA_CIVILIZACAO1 FOREIGN KEY (AMEACA) REFERENCES AMEACA(NOME) ON DELETE CASCADE,
    CONSTRAINT FK_AMEACA_CIVILIZACAO2 FOREIGN KEY (NOME_CIV, CATEG_CIV) REFERENCES CIVILIZACAO(NOME, CATEGORIA) ON DELETE CASCADE
);
